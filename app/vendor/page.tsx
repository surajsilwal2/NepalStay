        ...
        <div className="flex items-center justify-between mb-6">
          ...
          {stats.hotelStatus === "REJECTED" && (
            <div className="flex items-center gap-2 px-4 py-2 bg-red-50 border border-red-200 rounded-xl text-sm text-red-700">
              ...
              Listing rejected — check your email
            </div>
          )}
        </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-100 p-5">
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                {
                  label: "Available",
                  val: stats.rooms.AVAILABLE ?? 0,
                  cls: "bg-green-50 text-green-700 border-green-200",
                },
                {
                  label: "Occupied",
                  val: stats.rooms.OCCUPIED ?? 0,
                  cls: "bg-blue-50 text-blue-700 border-blue-200",
                },
                {
                  label: "Cleaning",
                  val: stats.rooms.CLEANING ?? 0,
                  cls: "bg-yellow-50 text-yellow-700 border-yellow-200",
                },
                {
                  label: "Maintenance",
                  val: stats.rooms.MAINTENANCE ?? 0,
              ...
              {[
                {
                  href: "/vendor/hotel",
                  icon: Building2,
                  label: "Edit Hotel Listing",
                  sub: "Update description, amenities, photos",
                },
                {
                  href: "/vendor/rooms",
                  icon: BedDouble,
                  label: "Manage Rooms",
                  sub: "Add, edit, or deactivate rooms",
                },
                {
                  href: "/vendor/bookings",
                  icon: CalendarCheck,
                  label: "View Bookings",
                  sub: "Confirm, check-in, check-out guests",
                },
                {
                  href: "/vendor/reviews",
                  icon: Star,
                  label: "Guest Reviews",
                  sub: "See what guests are saying",
                },
